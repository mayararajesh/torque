...
<!--          <a class="brand" href="#">abound <small>admin theme v1.1</small></a>-->
          ...
          <div class="nav-collapse">
			...
			$this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'      =>NavMenu::topNavMenuItems(),
//		    'items'=>array(
//				array('label'=>'Home', 'url'=>array('/site/index')),
//				array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
//				array('label'=>'Monitor', 'url'=>array('/monitor/index'), 'visible'=>Yii::app()->user->checkAccess('monitor')),
//                                array('label'=>'Monitor Overview', 'url'=>array('/monitor/monitorParam'), 'visible'=>Yii::app()->user->checkAccess('monitor')),
//				array('label'=>'Manage', 'url'=>array('/manage/index'), 'visible'=>Yii::app()->user->checkAccess('manager')),
//				array('label'=>'Settings', 'url'=>array('/setting/index'), 'visible'=>Yii::app()->user->checkAccess('admin')),
//				array('label'=>'Preferences', 'url'=>array('/pref/index'), 'visible'=>Yii::app()->user->checkAccess('authenticated')),
//				array('label'=>'Documents', 'url'=>array('/docs/index')),
