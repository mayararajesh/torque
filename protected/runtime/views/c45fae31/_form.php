...
<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'enabled', array('uncheckValue' => NULL, 'value' => '1')); ?> Yes
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'queue_type', array('uncheckValue' => NULL, 'value' => 'execution')); ?> Execution
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'acl_group_sloppy', array('uncheckValue' => NULL, 'value' => '0')); ?> Disable
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'acl_logic_or', array('uncheckValue' => NULL, 'value' => '0')); ?> Disable
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'acl_user_enable', array('uncheckValue' => NULL, 'value' => '0')); ?> Disable
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->radioButton($model, 'acl_host_enable', array('uncheckValue' => NULL, 'value' => '0')); ?> Disable
    </div>
