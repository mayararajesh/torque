...
/**
 * This is the model class for table "resources_max".
 *
 * The followings are the available columns in table 'resources_max':
 * @property integer $id
 ...
 */
class ResourcesMax extends CActiveRecord
{
	/**
	 ...
	 * @return ResourcesMax the static model class
	 */
