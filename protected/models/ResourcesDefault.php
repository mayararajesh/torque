...
/**
 * This is the model class for table "resources_default".
 *
 * The followings are the available columns in table 'resources_default':
 * @property integer $id
 ...
 */
class ResourcesDefault extends CActiveRecord
{
	/**
	 ...
	 * @return ResourcesDefault the static model class
	 */
